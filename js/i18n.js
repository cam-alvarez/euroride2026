...
export const STR = {
  ...
  chat: {
    ...
    convs: { en: 'Conversations', es: 'Conversaciones' },
    allChats: { en: 'All chats', es: 'Todos los chats' },
    newConv: { en: 'New', es: 'Nuevo' },
    deleteConv: { en: 'Delete this conversation', es: 'Eliminar esta conversación' },
    renameQ: { en: 'Name this conversation', es: 'Nombra esta conversación' },
    untitled: { en: 'New chat', es: 'Chat nuevo' },
