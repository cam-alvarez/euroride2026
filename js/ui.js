...
export const icons = {
  ...
  chat: I('<path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h11A2.5 2.5 0 0 1 20 6.5v7a2.5 2.5 0 0 1-2.5 2.5H9.5L4.5 20v-4"/><path d="M8 9h8M8 12.5h5"/>'),
  pin: I('<path d="M12 21s-6.5-5.5-6.5-10.5a6.5 6.5 0 0 1 13 0C18.5 15.5 12 21 12 21Z"/><circle cx="12" cy="10.2" r="2.3"/>'),
  send: I('<path d="M4 12 20 4l-4.5 16-4-6.5L4 12Z"/><path d="m11.5 13.5 4-4"/>')
};
